...
import example.sudokusolver.*
import kotlin.random.Random

// https://medium.com/@typical.dev/lets-make-the-sudoku-generator-library-in-kotlin-8e0dd45c72b6
class Generator private constructor(level: Level?) {
